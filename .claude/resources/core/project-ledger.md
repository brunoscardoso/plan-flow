...
## Instinct Entry Format

New ledger entries should follow the **instinct format** — structured, confidence-weighted lessons that enable pattern matching across sessions.

### Format

```markdown
### instinct-id-kebab-case [confidence: 0.X]
**Trigger:** When [specific situation occurs]
**Action:** [What to do]
**Evidence:** [What confirmed this pattern]
...
|-------|-------|----------|
| 0.3 | Tentative | Suggested but not enforced — needs more evidence |
| 0.5 | Moderate | Applied when clearly relevant |
| 0.7 | Strong | Auto-applied in matching situations |
| 0.9 | Near-certain | Core project behavior, rarely questioned |

### Confidence Evolution

**Confidence increases when:**
- The same pattern is observed across multiple plans or sessions
- The user doesn't correct the behavior over time
- Other evidence corroborates (e.g., tests pass, builds succeed)

**Confidence decreases when:**
- The user explicitly corrects the approach
- Contradicting evidence emerges (e.g., pattern causes failures)
- The instinct hasn't been relevant for an extended period (staleness)
...
### prefer-integration-tests [confidence: 0.7]
...
Instinct entries nest within existing ledger sections (Project Quirks, What Works, etc.). Existing free-text entries remain valid — no migration needed. New entries should use the instinct format when the lesson is reusable across sessions.
