...
| -------------------------------------- | ------------------------------------ |
| Use Web Search/Fetch tool              | Fetch documentation from URLs        |
...
> **Important**: The ONLY writable locations are `flow/contracts/`, `flow/brain/`, and `flow/log.md`. No source code or other files should be modified.
